bl_info = {
    ...
    "description": "Generate supports in a STL file from an STL file object",
...
class BUTTON_PT_import_export(Panel):
    ...
    bl_label = '1. Import/Export'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = 'Support Generator'
...
class BUTTON_PT_rotation_offset(Panel):
    ...
    bl_label = '2. Rotation and offset'
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = 'Support Generator'
...
class BUTTON_OT_button_regenerate_bottom(Operator):
  ...
  bl_description = 'Regenerate supports bottom if the bottom is bad generated'
  bl_options = {'REGISTER', 'UNDO'}
...
class BUTTON_OT_button_separate_faces(Operator):
  ...
  bl_description = 'Separate selected faces in a new mesh and delete the base mesh'
  bl_options = {'REGISTER', 'UNDO'}
...
class BUTTON_OT_button_add_lattice(Operator):
  ...
  bl_description = 'Add a lattice object with the selected mesh size and location'
  bl_options = {'REGISTER', 'UNDO'}
...
class BUTTON_OT_button_select_lattice(Operator):
  ...
  bl_description = 'Select faces of the selected mesh in the lattice '
  bl_options = {'REGISTER', 'UNDO'}
...
def register():    
    ...
    bpy.types.Scene.offset = bpy.props.FloatProperty(name = "Offset z", description="Offset z of the selected mesh", default = 0, options={'SKIP_SAVE'}, min = -10, max = 10, soft_min = -10, soft_max = 10, step = 10,get=Get_And_Set_Offset.get_offset, set=Get_And_Set_Offset.set_offset, unit = 'LENGTH')
        
    bpy.types.Scene.max_angle = bpy.props.FloatProperty(name="Max Angle", description="Max angle between the downward vector and the face normal below which the faces are selected", default = pi/4, options={'SKIP_SAVE'}, min = 0, max = pi/2, soft_min = 0, soft_max = pi/2, step = 100, unit = 'ROTATION')    
    ...
    bpy.types.Scene.min_area = bpy.props.FloatProperty(name="Min Area", description="Minimum value of the area to select the faces of a piece of a mesh", default = 0.1, options={'SKIP_SAVE'}, min = 0, max = 1, soft_min = 0, soft_max = 10, step = 1, unit = 'AREA')
    
    bpy.types.Scene.min_angle_z = bpy.props.FloatProperty(name="Min Angle z", description="Min angle between the normal and downward vector where the connected faces are selected", default = pi/2, options={'SKIP_SAVE'}, min = 0, max = radians(181),soft_min = 0, soft_max = radians(181), step = 100, unit = 'ROTATION')
    bpy.types.Scene.max_angle_z = bpy.props.FloatProperty(name="Max Angle z", description="Max angle between the normal and downward vector where the connected faces are selected", default = pi/2, options={'SKIP_SAVE'}, min = 0, max = radians(181),soft_min = 0, soft_max = radians(181), step = 100, unit = 'ROTATION')
    bpy.types.Scene.resize = bpy.props.FloatProperty(name = "Resize", description="Size value to resize the selected mesh", default = 0, options={'SKIP_SAVE'}, min = -10, max = 10, soft_min = -10, soft_max = 10, step = 1, unit = 'LENGTH')    
    ...
    bpy.types.Scene.lattice_size_x = bpy.props.FloatProperty(name = "Size X", description="Lattice size in x", default = 0, step = 10, unit = 'LENGTH')
    bpy.types.Scene.lattice_size_y = bpy.props.FloatProperty(name = "Size Y", description="Lattice size in y", default = 0, step = 10, unit = 'LENGTH')
    bpy.types.Scene.lattice_size_z = bpy.props.FloatProperty(name = "Size Z", description="Lattice size in z", default = 0, step = 10, unit = 'LENGTH')
    bpy.types.Scene.lattice_offset_x = bpy.props.FloatProperty(name = "Offset X", description="Lattice offset in x", default = 0, step = 10, unit = 'LENGTH')
    bpy.types.Scene.lattice_offset_y = bpy.props.FloatProperty(name = "Offset Y", description="Lattice offset in y", default = 0, step = 10, unit = 'LENGTH')
    bpy.types.Scene.lattice_offset_z = bpy.props.FloatProperty(name = "Offset Z", description="Lattice offset in z", default = 0, step = 10, unit = 'LENGTH')
    
    bpy.types.Scene.voxel_size = bpy.props.FloatProperty(name="Voxel Size", description="Voxel size in object space used for volume evaluation", default = 0.01, options={'SKIP_SAVE'}, min = 0.001, max = 0.1,soft_min = 0.001, soft_max = 0.1, step = 1, unit = 'LENGTH')
    bpy.types.Scene.decimate_ratio = bpy.props.FloatProperty(name="Decimate Ratio", description="Ratio of faces to reduce to", default = 0.01, options={'SKIP_SAVE'}, min = 0, max = 1,soft_min = 0, soft_max = 1, step = 1)
    bpy.types.Scene.level_blocks = bpy.props.IntProperty(name="Level Blocks", description="Blocks resolution", default = 5, options={'SKIP_SAVE'}, min = 1, max = 9,soft_min = 1, soft_max = 9, step = 1)
