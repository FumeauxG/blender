...
#########################################
bl_info = {
    "name": "zeBlenderTestKeypad1",
    "description": "Test automatized Blender auto",
    "author": "Fumeaux Gaëtan",
    "version": (1, 0),
    "blender": (2, 92, 0),
    "category": "Object",
...
class WorkMacro(bpy.types.Operator):
    """Work Macro"""
    bl_idname = "object.auto_support"
    bl_label = "Auto support"
    bl_options = {'REGISTER', 'UNDO'}


    def execute(self, context):

        print("Start auto support") 
        myFunction()
        return {'FINISHED'}
...
def register():
    ...
    kmi = km.keymap_items.new(WorkMacro.bl_idname, 'R', 'PRESS', ctrl=True, shift=True)
