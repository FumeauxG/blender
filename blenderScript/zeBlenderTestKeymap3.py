...
#########################################
bl_info = {
    "name": "zeBlenderTestKeypad3",
    "description": "Test automatized Blender auto math",
    "author": "Fumeaux Gaëtan",
    "version": (1, 0),
    "blender": (2, 92, 0),
    "category": "Object",
...
class WorkMacro(bpy.types.Operator):
    """Work Macro"""
    bl_idname = "object.auto_support_math"
    bl_label = "Auto support math"
    bl_options = {'REGISTER', 'UNDO'}


    def execute(self, context):

        print("Start auto support math") 
        myFunction()
        return {'FINISHED'}
...
def register():
    ...
    kmi = km.keymap_items.new(WorkMacro.bl_idname, 'T', 'PRESS', ctrl=True, shift=True)
